...
|:-----------------|----------------:|---------------:|---------------:|---------------:|--------------------:|
| (-0.001, 146.5]  |         4.690 |        4.608 |        4.568 |        4.631 |             4.624 |
| (146.5, 248.9]   |         4.677 |        4.626 |        4.608 |        4.615 |             4.614 |
...
Notably, the best-performing model used a very small alpha value (10<sup>-5</sup>), implying that very minimal regularization yielded the lowest average validation error. This suggests that our final model actually benefits from retaining more and more of the original feature weights, and that the data (particuarly the textual reviews) contains enough valuable information to justify a more flexible and complex model.
